...
// DRAM EXCHAGE  
  ...
  { file: "./datamanage/semiin", path: "/api/datamanage/semiin/getitemlist", method: "getItemList", session: "uncheck", type: "get",},
  { file: "./datamanage/semiin", path: "/api/datamanage/semiin/updateitem", method: "updateItem", session: "uncheck", type: "post",},
  { file: "./datamanage/semiin", path: "/api/datamanage/semiin/deleteitem", method: "deleteItem", session: "uncheck", type: "post",},
  { file: "./datamanage/semiin", path: "/api/datamanage/semiin/excelupload", method: "excelUpload", session: "uncheck", type: "post",},
