...
const DB_INFO = {
	host: config.DP_FUTURE.host,
	port: config.DP_FUTURE.port,
	user: config.DP_FUTURE.user,
	password: config.DP_FUTURE.password,
	database: config.DP_FUTURE.database,
...
module.exports = class {
	...
	getMapper(dirLevel) {
		...
		ibatisMapper.createMapper([
			// dirPrefix + "database/mysql/macromanager/future.xml"
		]);
