<template>
  <div>
    <v-toolbar color="white">
      <v-toolbar-title>반도체지수 (M203UBASEDIN :수정)</v-toolbar-title>
      <v-spacer></v-spacer>
    </v-toolbar>
...
import UpdateModal from "./SemiInModModal.vue";
...
export default {
  ...
  methods: {
    ...
    deleteItem: function (item) {
      ...
      axios
        .post(
          Config.base_url + "/api/datamanage/semiin/deleteitem",
          item
        )
    ...
    getList: function () {
      ...
      // console.log("getList");
      axios
        .get(Config.base_url + "/api/datamanage/semiin/getitemlist", {
          params: {
            sdate: vm.sdate,
            edate: vm.edate,
            jcode: vm.jcode,
